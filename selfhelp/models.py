...
class WOExtraValue(models.Model):
    ...
    """
    workorder = models.ForeignKey(WorkOrder,verbose_name=_("workorder"),null=True,on_delete=models.SET_NULL)
    param_name = models.ForeignKey(ExtraParam,verbose_name=_("extra param"),null=True,on_delete=models.SET_NULL)
...
class Loan(generic.BO):
    ...
    title = models.CharField(_("title"),max_length=const.DB_CHAR_NAME_120)
    description = models.TextField(_("description"),blank=True,null=True)
    project = models.ForeignKey(Project,verbose_name=_("project"),null=True,on_delete=models.SET_NULL)
    user = models.ForeignKey(User,verbose_name=_("user"),blank=True,null=True,on_delete=models.SET_NULL)
...
class ReimbursementItem(models.Model):
    ...
    """
    import datetime
    reimbursement = models.ForeignKey(Reimbursement,verbose_name=_("reimbursement"),null=True,on_delete=models.SET_NULL)
    expense_account = models.ForeignKey(ExpenseAccount,verbose_name=_("expenses account"),null=True,on_delete=models.SET_NULL)
