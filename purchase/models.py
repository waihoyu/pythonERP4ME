...
class PurchaseOrder(generic.BO):
    ...
    partner = models.ForeignKey(Partner, verbose_name=_("partner"), limit_choices_to={"partner_type": "S"}, null=True,
...
class POItem(models.Model):
    ...
    """
    index_weight = 2
    po = models.ForeignKey(PurchaseOrder, verbose_name=_("purchase order"), null=True, on_delete=models.SET_NULL)
    material = models.ForeignKey(Material, verbose_name=_("material"), limit_choices_to={"is_virtual": "0"}, null=True,
                                 on_delete=models.SET_NULL)
