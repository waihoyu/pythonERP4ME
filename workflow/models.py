...
class Modal(models.Model):
    ...
    content_type = models.ForeignKey(ContentType,verbose_name=_("content type"),limit_choices_to={"app_label__in":['basedata','organ']},null=True,on_delete=models.SET_NULL)
...
class Node(models.Model):
    ...
    index_weight = 2
    modal = models.ForeignKey(Modal,verbose_name=_("workflow model"),null=True,on_delete=models.SET_NULL)
...
class Instance(models.Model):
    ...
    starter = models.ForeignKey(User,verbose_name=_("start user"),related_name="starter",null=True,on_delete=models.SET_NULL)
...
class History(models.Model):
    ...
    index_weight = 5
    inst = models.ForeignKey(Instance,verbose_name=_("workflow instance"),null=True,on_delete=models.SET_NULL)
    node = models.ForeignKey(Node,verbose_name=_("workflow node"),blank=True,null=True,on_delete=models.SET_NULL)
    user = models.ForeignKey(User,verbose_name=_("submitter"),null=True,on_delete=models.SET_NULL)
...
class TodoList(models.Model):
    ...
    app_name = models.CharField(_("app name"),max_length=const.DB_CHAR_NAME_60,blank=True,null=True)
    model_name = models.CharField(_("model name"),max_length=const.DB_CHAR_NAME_60,blank=True,null=True)
    user = models.ForeignKey(User,verbose_name=_("handler"),null=True,on_delete=models.SET_NULL)
