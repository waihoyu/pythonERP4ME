...
class DataImport(generic.BO):
    ...
    description = models.TextField(_('description'),blank=True,null=True)
    content_type = models.ForeignKey(ContentType,verbose_name=_("content type"),limit_choices_to={"app_label__in":['basedata','organ','auth']},on_delete=models.SET("basedata"))
