...
class Inventory(generic.BO):
    ...
    warehouse = models.ForeignKey(Warehouse, verbose_name=_("warehouse"), null=True, on_delete=models.SET_NULL)
    material = models.ForeignKey(Material, verbose_name=_("material"), null=True, on_delete=models.SET_NULL)
    measure = models.ForeignKey(Measure, verbose_name=_("measure"), null=True, on_delete=models.SET_NULL)
...
class StockIn(generic.BO):
    ...
    po = models.ForeignKey(PurchaseOrder, verbose_name=_("purchase order"), null=True,
                           limit_choices_to={"entry_status": "0"}, blank=True, on_delete=models.SET_NULL)
...
class WareReturn(generic.BO):
    ...
    org = models.ForeignKey(Organization, verbose_name=_("organization"), blank=True, null=True,
                            on_delete=models.SET_NULL)
    title = models.CharField(_("title"), max_length=const.DB_CHAR_NAME_40)
    out = models.ForeignKey(StockOut, verbose_name=_('StockOut'), null=True, on_delete=models.SET_NULL)
    amount = models.DecimalField(_("money of amount"), max_digits=14, decimal_places=4, blank=True, null=True)
    user = models.ForeignKey(User, verbose_name=_("out user"), blank=True, null=True, on_delete=models.SET_NULL)
    status = models.CharField(_("status"), max_length=const.DB_CHAR_CODE_2, default='0', choices=STATUS)
    execute_time = models.DateTimeField(_("execute time"), blank=True, null=True)
...
class InitItem(InOutDetail):
    ...
    期初入库明细
    """
    master = models.ForeignKey(InitialInventory, null=True, on_delete=models.SET_NULL)
...
class InItem(InOutDetail):
    ...
    入库单明细
    """
    master = models.ForeignKey(StockIn, null=True, on_delete=models.SET_NULL)
...
class OutItem(InOutDetail):
    ...
    出库单明细
    """
    master = models.ForeignKey(StockOut, null=True, on_delete=models.SET_NULL)
...
class ReturnItem(InOutDetail):
    ...
    返库单明细
    """
    master = models.ForeignKey(WareReturn, null=True, on_delete=models.SET_NULL)
...
class AdjustItem(InOutDetail):
    ...
    库存调整明细
    """
    master = models.ForeignKey(WareAdjust, null=True, on_delete=models.SET_NULL)
    inventory = models.ForeignKey(Inventory, blank=True, null=True, verbose_name=_("inventory material"),
                                  on_delete=models.SET_NULL)
